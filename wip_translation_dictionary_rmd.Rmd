...
export_fields_u31_df <- jsonlite::fromJSON(export_fields_u31_json) %>% 
  na_if('')
readr::write_csv(export_fields_u31_df, 
                 "Export Fields/export_fields_u31_df.csv", na = "")
...
export_fields_u32_df <- jsonlite::fromJSON(export_fields_u32_json) %>% 
  na_if('')
readr::write_csv(export_fields_u32_df, 
                 "Export Fields/export_fields_u32_df.csv", na = "")
