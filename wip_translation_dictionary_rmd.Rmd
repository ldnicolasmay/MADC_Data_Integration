...
dictionary (`trans_dict_std`) need to be included in this standardized 
translation dictionary. Otherwise, these fields won't be included in the 
integrated dataset.
...
Write the resulting harmonized dataset `df_u2_u3a_u3n` to a CSV file of the same
name.
